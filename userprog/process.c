...
load (const char *file_name, void (**eip) (void), void **esp) 
{
  ...
  char file_name_array[MAX_LENGTH];
//creates a copy of file_name as strtok_r modifies the string
  strlcpy(file_name_array, file_name, MAX_LENGTH);
  char *argv[MAX_LENGTH];
  int argc;
  get_args(file_name_array, argv, &argc);
...
/* Create a minimal stack by mapping a zeroed page at the top of
   user virtual memory. */ 
//Added pushing parameters onto stack
static bool
