...
//////           ADDED IN           ////////
////////////////////////////////////////////
//Detect position in ready list
static bool
prio_detect (const struct list_elem *a_, const struct list_elem *b_,
			void *aux UNUSED)
{
...
/*bool least_sleep(const struct list_elem *a, const struct list_elem *b, void *aux){
	struct thread *a_thread = (struct thread*)a;
	struct thread *b_thread = (struct thread*)b;
